...
created: 2026-05-05
updated: 2026-06-01
sources: ["[[wiki/sources/hoDenoisingDiffusionProbabilistic2020]]", "[[wiki/sources/songDenoisingDiffusionImplicit2022]]", "[[wiki/sources/songScoreBasedGenerativeModeling2021]]", "[[wiki/sources/lipmanFlowMatchingGenerative2023]]", "[[wiki/sources/liuFlowStraightFast2022a]]", "[[wiki/sources/rombachHighResolutionImageSynthesis2022]]", "[[wiki/sources/zhangAddingConditionalControl2023]]", "[[wiki/sources/mengSDEditGuidedImage2022]]", "[[wiki/sources/zhouDenoisingDiffusionBridge2023]]"]
---
...
- 🆕 **Bridge 线（2026-06-01 DDBM ingest + 用户定向，推论 4 的载体）**：[[wiki/methods/ddbm|DDBM]] 已 ingest，建 [[wiki/concepts/diffusion-bridge]] / [[wiki/concepts/doob-h-transform]] / [[wiki/concepts/infinitesimal-generator]] / [[wiki/concepts/stochastic-interpolants]]（后者 draft，原文待 ingest）。**thesis 选定方向 = bridge-SDE inversion/editing**（[[research/ideas]] / [[research/thesis]]；全景地图 [[wiki/synthesis/bridge-sde-editing-landscape]]）。**仍待 ingest（按 thesis 距离）**：Stochastic Interpolants（Albergo，统一框架）/ I²SB（tractable Schrödinger Bridge）/ Schrödinger Bridge·Bridge-Matching（Shi 2023）/ BBDM / EDM（Karras 2022，DDBM 的 preconditioning+sampler 基础）；以及 bridge-SDE 的 inversion 与加速现状 sweep（2024 工作）。
